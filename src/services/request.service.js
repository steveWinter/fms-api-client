 ...
 * method will add an expired property to the error response if it receives an invalid
 * token response.
 * @param  {Object} error The error received from the requested resource.
 ...
 * This function will test the url for an http protocol and reject if none exist.
